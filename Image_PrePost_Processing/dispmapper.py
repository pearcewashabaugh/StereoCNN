...
from Image_PrePost_Processing.image_preprocessor import image_resize
...
def projector3D(pic_height_px, leftim_n, rightim_n):
    #pic_height_pix = 50
    
    # leftim_n, rightim_n = image_resize('Data/Pictures_Data/left.jpeg',
